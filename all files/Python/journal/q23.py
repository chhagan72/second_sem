# Write a Python program which allows you to extract the content of a file from the 3rd line to
...
input_file = "input_file.txt"  # Replace "input_file.txt" with the name of your input file
